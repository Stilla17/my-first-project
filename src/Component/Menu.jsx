...
const Menu = () => {
    return (
        <>
            <div clas="flex h-[100vh] bg-gray-100 ">

                <nav className="w-64 bg-white shadow-lg flex flex-col h-[100vh] fixed">
                    ...
                    <ul className="flex-1 px-2 py-4 space-y-1">
                        ...
                        <li>
                            <Link to="/posts" className="flex items-center px-3 py-2 bg-purple-100 text-purple-700 rounded-lg">
